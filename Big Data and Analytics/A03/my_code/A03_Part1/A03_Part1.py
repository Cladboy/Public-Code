...
# FUNCTION my_main
# ------------------------------------------
def my_main(input_folder, output_file, year):
    ...
    for item in input:
        ...
        for line in input_data:
            ...
            start_time = str(parameters[0])
            start_time = start_time.split(" ")
            start_time = start_time[1]
            start_time = start_time.split(":")
            start_hour = start_time[0]

            user_type = parameters[12]
            birth_year = parameters[13]

            if birth_year >= year and user_type == "Subscriber":
                if birth_year not in resDict:
                    resDict[birth_year] = startHourDict.copy()
                    resDict[birth_year][start_hour] = 1
                else:
                    resDict[birth_year][start_hour] += 1
    finalResDict = {}
...
if __name__ == '__main__':
    ...
    input_folder = "../../my_dataset_1/"
    output_file = "../../my_results/A03_Part1/result.txt"
    year = 1990
    ...
    my_main(input_folder, output_file, year)
